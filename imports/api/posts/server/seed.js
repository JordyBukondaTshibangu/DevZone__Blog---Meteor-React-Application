...
function insertPost({title, tagline, description, image, author, email, content, likes, comments}){
    PostsCollection.insert({title, tagline, description, image, author, email, likes, comments, content, createdAt : new Date()});
}

if(PostsCollection.find().count() === 0 ){
    posts.forEach(post => {
        const { title, tagline, description, image, author, email, content, likes, comments } = post;
        insertPost({title, tagline, description, image, author, email, content, likes, comments })
    })
}