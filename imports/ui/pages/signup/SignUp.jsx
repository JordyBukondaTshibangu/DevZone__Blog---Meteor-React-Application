        ...
        <div className="login-container">
            ...
            <div className="login-box">
                ...
                <form onSubmit={handleSignUp}>
                     ...
                     <div className="input-group">
                       <span className="date-of-birth" onClick={()=> setShowCalendar(!showCalendar)}>{showCalendar ? '':'Click to enter your birth day'}</span>
                       {
                           showCalendar && 
                           <>
                                <span> Date of Birth : <b>{moment(dateState).format('MMMM Do YYYY')}</b> </span>
                                <Calendar 
                                    value={dateState}
